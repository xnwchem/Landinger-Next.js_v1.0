...
export const metadata: Metadata = {
    title: 'Sign Up | Landinger - Multipurpose Tailwind CSS Landing Page Template',
};
            ...
            <div className="container">
                ...
                >
                    <div className="lg:mb-12.5 md:mb-10 mb-7.5 text-center">
                        ...
                        <p className="mb-2.5">Create an account and start using Landinger. </p>
                    </div>
                    <div className="bg-body-bg md:p-10 p-5 rounded-2xl">
                        ...
                        <div>
                            <p>
                                ...
                                <Link href={getLocalePath('/log-in', locale)} className="underline text-dark">
                                    log in
                                </Link>{' '}
                            </p>
                        </div>
                    ...
                    <div className="flex justify-between md:gap-5 md:flex-row gap-2.5 flex-col mt-7.5 items-center">
                        <Link href={getLocalePath('/home-1', locale)}>
                            {' '}
